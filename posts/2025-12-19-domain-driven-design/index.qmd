...
So if you already read that, you can skip down to [the next section](#vocalpy-domain-driven).
...
## From Domain-Driven Design to VocalPy {#vocalpy-domain-driven}
...
These drawings should be part of the [theory](https://cekrem.github.io/posts/programming-as-theory-building-naur/) 
of your scientific software.
...
where I first introduced VocalPy, you can see where I included similar schematics.
...
You can see how I've continued this way, looking at the diagram I show at the top of that 
...
Here I want to point to a talk I gave, fitting title "VocalPy: a case study of domain-driven development".
(Huge thank you to the [DoePy community] and [Don't Use this Code] for inviting me, 
and letting me think out loud about these things.)
...
Part of the reason I want to include this, is that I 
talk about how my attempt to apply domain-driven design has 
led me to do things that *maybe* clashes with some recommendations 
...
This might seem like I'm going off topic, 
but what I want to show here is that I'm not claiming that domain-driven design 
is some magic method you can follow to produce correct research code.
Please also note that I definitely do not claim to be any smarter or more experienced of a developer than Gaël Varoquaux. 
...
I hope I've shown what that might look like here.