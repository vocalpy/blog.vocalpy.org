...
Here's an overview of what I'll tell you about below.
...
- [Add more example data and make it easier to work with](#sec-example-data)
...
and it's easier to see from the docs how you can take what you get out of VocalPy and 
...
statistical models for jointly segmenting and classifying animal sounds that I'm developing with Yarden Cohen, 
based on [what we're learning about existing models](https://github.com/vocalpy/Nicholson-Cohen-SfN-2023-poster).
In the meantime, we'd love to have your input in our [forum](https://forum.vocalpy.org/), 
